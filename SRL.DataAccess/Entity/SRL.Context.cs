...
namespace SRL.Data_Access.Entity
{
    ...
    public partial class BACKUP_SRL_20180613Entities : DbContext
    {
        ...
        public virtual ObjectResult<API_ORDER_LIST_Result> API_ORDER_LIST(string oRD_ORDER_NUMBER, Nullable<int> rETAILER_CHAIN_ID, Nullable<System.DateTime> oRDER_DATE_FROM, Nullable<System.DateTime> oRDER_DATE_TO, Nullable<int> oRDER_STATUS, Nullable<System.DateTime> cI_DATE_FROM, Nullable<System.DateTime> cI_DATE_TO, Nullable<System.DateTime> vALIDATION_DEADLINE, string uSER, string aCTOR_ID_FROM, string aCTOR_ID_TO, string oRDER_NUMBER, Nullable<bool> sHOP_COUNT_OK, Nullable<bool> sHOP_COUNT_NOK, Nullable<bool> vALIDATION_DEADLINE_OPEN, Nullable<bool> vALIDATION_DEADLINE_EXCEEDED, Nullable<bool> vALIDATION_DEADLINE_PASSED)
        {
            var oRD_ORDER_NUMBERParameter = oRD_ORDER_NUMBER != null ?
                new ObjectParameter("ORD_ORDER_NUMBER", oRD_ORDER_NUMBER) :
                new ObjectParameter("ORD_ORDER_NUMBER", typeof(string));
